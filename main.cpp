...
int main()
{
    ...
    string analizaSERP, frazaGoogleSERP = "dom we wrocławskim lesie";
    bool czyWykonacNowaAnalizeSERP = true;

    proceduraWypisywaniaStrumieniowego(introText());

    czyWykonacNowaAnalizeSERP = true;
    if(czyWykonacNowaAnalizeSERP == true)
    {
    ...
    proceduraWypisywaniaPodsumowaniaSERP(frazaGoogleSERP);
...
void przygDoPorowStronSERP(string analizaPlikuHTML)
{
    char ch;
    fstream plik;
...
void proceduraWypisywaniaPodsumowaniaSERP(string frazaGlownaSERP)
{
    ...
    char ch;
    cout<<"Czy wypisać szczegółowe wyniki dla każdego wyniku oddzielnie? "<<endl;
